...
<!-- Mirrored from live.themewild.com/techrun/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Mar 2025 07:00:35 GMT -->
<head>
    <!-- meta tags -->
    <meta charset="UTF-8">
...
<body>
                ...
                <div class="header-top-wrapper">
                    <div class="header-top-left">
                        <div class="header-top-contact">
                            <ul>
                                <li><a href="#"><i class="far fa-map-marker-alt"></i>25/B Milford Road, New York</a>
                                </li>
                                <li><a href="tel:+21236547898"><i class="far fa-phone"></i>+2 123 654 7898</a></li>
                                <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#d7beb9b1b897b2afb6baa7bbb2f9b4b8ba"><i
                                            class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="adc4c3cbc2edc8d5ccc0ddc1c883cec2c0">[email&#160;protected]</span></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="main_nav">
                        <ul class="navbar-nav ms-auto">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu fade-up">
                                    <li><a class="dropdown-item" href="service.html">Service One</a></li>
                                    <li><a class="dropdown-item" href="service-2.html">Service Two</a></li>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu fade-up">
                                    ...
                                    <li><a class="dropdown-item" href="project-2.html">Project Two</a></li>
    ...
    <main class="home-2 main">
            ...
            <div class="hero-wrapper">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-md-6 col-lg-6">
                            <div class="hero-content">
                                ...
                                <div class="hero-btn wow animate__animated animate__fadeInUp" data-wow-duration="1s"
                                    data-wow-delay="1s">
                                    <a href="about.html" class="theme-btn theme-btn2">Contact Us</a>
                                    <div class="video-btn">
                        ...
                        <div class="col-md-6 col-lg-6">
                            <div class="hero-img">
                                <img src="assets/img/slider/hero-2.svg" alt="">
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- service area -->
        <div class="service-area2 py-120">
            <div class="container">
                <div class="row">
        ...
        <!-- skill-area -->
        <div class="skill-area bg py-120">
            <div class="container">
                    ...
                    <div class="row g-5 align-items-center">
                        <div class="col-lg-6 col-12">
                            <div class="skill-left">
                                <div class="skill-img">
                                    <img src="assets/img/skill/01.png" alt="thumb">
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-12">
                            <div class="skill-right">
                                ...
                                <h2 class="site-title">We Offers You <span>Best IT And Technology</span> Service</h2>
                                ...
                                <div class="skills-section">
                                    <div class="progress-box">
                                        <h5>IT Consulting <span class="pull-right">85%</span></h5>
                                        <div class="progress" data-value="85">
                                            <div class="progress-bar" role="progressbar"></div>
                                        </div>
                                    </div>
                                    <div class="progress-box">
                                        <h5>Web Development <span class="pull-right">65%</span></h5>
                                        <div class="progress" data-value="65">
                                            <div class="progress-bar" role="progressbar"></div>
                                        </div>
                                    </div>
                                    <div class="progress-box">
                                        <h5>Software Development <span class="pull-right">75%</span></h5>
                                        <div class="progress" data-value="75">
                                            <div class="progress-bar" role="progressbar"></div>
                                        </div>
                                    </div>
                                </div>
                                <a href="#" class="theme-btn mt-5">Learn More</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <!-- about area -->
        <div class="about-area bg py-120">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="about-right">
                            <div class="site-heading mb-3">
                                ...
                                <h2 class="site-title">We Offer Professional <span>IT Solutions</span> For Business</h2>
                            </div>
                ...
                <div class="row footer-widget-wrapper pt-100 pb-70">
                        ...
                        <div class="footer-widget-box about-us">
                            ...
                            <div class="footer-contact">
                                <ul>
                                    ...
                                    <li><a href="tel:+21236547898"><i class="far fa-phone"></i>+2 123 654 7898</a></li>
                                    <li><a href="https://live.themewild.com/cdn-cgi/l/email-protection#32414742425d404672574a535f425e571c515d5f"><i
                                                class="far fa-envelope"></i><span class="__cf_email__" data-cfemail="681b1d1818071a1c280d10090518040d460b0705">[email&#160;protected]</span></a> </li>
                                </ul>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="footer-widget-box list">
                            ...
                            <ul class="footer-list">
                                <li><a href="#"><i class="fas fa-caret-right"></i> IT Solutions</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Web Development</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Digital Marketing</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> App Development</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Networking Service</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> SEO Optimization</a></li>
                                <li><a href="#"><i class="fas fa-caret-right"></i> Data Analysis</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-3">
                ...
                <div class="row">
                    <div class="col-lg-6 align-self-center">
                        <p class="copyright-text">
                            &copy; Copyright <span id="date"></span> <a href="#"> Techrun </a> All Rights Reserved.
                        </p>
                    </div>
                    <div class="col-lg-6 align-self-center">
...
<!-- Mirrored from live.themewild.com/techrun/index-2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 19 Mar 2025 07:01:00 GMT -->
</html>